...
pub fn report_schema() -> Value {
    json!({
        ...
        "properties": {
            ...
            "large_functions": array_ref_schema("large_function"),
            "flutter_style": array_ref_schema("flutter_style_finding"),
            "semantic": { "$ref": "#/$defs/semantic_report" },
            ...
            "security_blind_spots": array_ref_schema("security_blind_spot"),
        ...
        "$defs": {
            ...
            "large_function": inventory::large_function_schema(),
            "flutter_style_finding": inventory::flutter_style_finding_schema(),
            "theme_token_evidence": inventory::theme_token_evidence_schema(),
            "semantic_report": inventory::semantic_report_schema(),
            "semantic_identity": inventory::semantic_identity_schema(),
            "semantic_evidence": inventory::semantic_evidence_schema(),
            "semantic_type_coupling": inventory::semantic_type_coupling_schema(),
            ...
            "security_blind_spot": inventory::security_blind_spot_schema(),
...
const SUMMARY_INTEGER_FIELDS: &[&str] = &[
    "files",
    "edges",
...
fn threshold_override_schema() -> Value {
    json!({
        ...
        "properties": {
            ...
            "max_unit_size": { "type": ["integer", "null"], "minimum": 1 },
