...
```bash
cargo install --git https://github.com/sgaabdu4/dart-decimate.git --tag v0.0.46 --locked
```
...
build, for example `dart-decimate 0.0.46`.
...
```bash
npx --yes dart-decimate@0.0.46 --strict
```
