...
```bash
cargo install --git https://github.com/sgaabdu4/dart-decimate.git --tag v0.0.53 --locked
```
...
build, for example `dart-decimate 0.0.53`.
...
```bash
npx --yes dart-decimate@0.0.53 --strict
```
